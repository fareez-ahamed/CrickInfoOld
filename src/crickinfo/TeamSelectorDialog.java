...
/*
 * TeamSelectorDialog.java
 *
 * Created on Jan 1, 2010, 2:35:41 AM
 */
...
public class TeamSelectorDialog extends javax.swing.JDialog {
    ...
    public TeamSelectorDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void swap1()throws Exception
    {
        ...
        sql="update players set status='DNP' where name='"+playerList1.getSelectedValue()+"' and team='"+team1id+"'";
        st.executeUpdate(sql);
        sql="update players set status='P' where name='"+subList1.getSelectedValue()+"' and team='"+team1id+"'" ;
        st.executeUpdate(sql);
        loadPlayerList1();
    }
    ...
    public void swap2()throws Exception
    {
        ...
        sql="update players set status='DNP' where name='"+playerList2.getSelectedValue()+"' and team='"+team2id+"'";
        st.executeUpdate(sql);
        sql="update players set status='P' where name='"+subList2.getSelectedValue()+"' and team='"+team2id+"'";
        st.executeUpdate(sql);
        loadPlayerList2();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TeamSelectorDialog dialog = new TeamSelectorDialog(new javax.swing.JFrame(), true);
